...
import './PatientInformation.css'; // 导入CSS文件
...
function PatientInformation() {
    ...
    return (
        <div className="container">
                ...
                <div>
                    <div className="personal-info">
                        ...
                        <div className="avatar">
                            <img src="path_to_avatar_image" alt="Patient Avatar" />
                        </div>
                            ...
                            <tbody>
                                {patientInfo.map((info) => (
                                    <tr key={info.id}>
                                        ...
                                        <td>
                                            <button className="view-button" onClick={() => handleResultClick(info.id)}>View Result</button>
                                        </td>
                                        <td>
                                            <button className="view-button" onClick={() => handleSuggestionClick(info.id)}>View Suggestion</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
            ...
            <button className="back-button" onClick={() => navigate('/profile-management')}>Back to Profile Management</button>
        </div>
    );
}
